...
const PriceCard = ({ priceCategory, dollor, features }) => {
    return (
        <div className='bg-white text-slate-900 m-4 rounded-xl overflow-hidden'>
            <div className='text-center bg-darkColor text-white font-medium py-4 uppercase'>
                <p>{priceCategory}</p>
            </div>
            ...
            <p className='text-base px-10 py-2 text-slate-500'>
                Now radiant parting quoth all spoken she tempest seeming. Both ipsum dolor sit amet consectetur adipisicing elit. Omnis ipsum sint voluptatibus, magnam officia voluptates..
            </p>
            ...
            <div className='text-2xl'>
                ...
                <GreenButton title='get started' className='capitalize text-lg w-full py-4 mt-10 rounded-none hover:border-none' />
            </div>
        </div>
    )
}
